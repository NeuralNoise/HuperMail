...
<div class="bs-example">
    <h1>Sign Up</h1>
    <form class="form-horizontal" name="form1" method="post" action="adduser.php">
        <div class="form-group">
            <label class="control-label col-xs-3" for="inputEmail">Email:</label>
            <div class="col-xs-9">
                <input type="username" class="form-control" id="inputEmail" placeholder="Email" name="login">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-3" for="inputPassword">Password:</label>
            <div class="col-xs-9">Last
                <input type="password" class="form-control" id="inpuLasttPassword" placeholder="Password" name="pwd">
            </div>
        </div>
        <div class="form-group">
